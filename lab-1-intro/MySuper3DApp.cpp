...
#pragma endregion Window init
	...
	// Step 02: Create Device with the SwapChain
	...
	res = D3DCompileFromFile(L"./Shaders/MyVeryFirstShader.hlsl", Shader_Macros /*macros*/, nullptr /*include*/, "PSMain", "ps_5_0" /*pixel shader*/, D3DCOMPILE_DEBUG | D3DCOMPILE_SKIP_OPTIMIZATION, 0, &pixelBC, &errorPixelCode);
	...
	// Step 12: Create Window Message Loop
	MSG msg = {};
